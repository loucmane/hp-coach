...
# 2. mechanical stage
# glob las-*/elf-* explicitly — NOT *.json (expectations.json is metadata, not a candidate)
python3 scripts/run_mech.py /tmp/evalrun/las-*.json /tmp/evalrun/elf-*.json --parsed-dir <repo>/data/parsed --out /tmp/evalrun/verdicts.jsonl
