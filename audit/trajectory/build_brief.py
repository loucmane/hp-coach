...
def main():
    ...
    brief = [
        ...
        '',
        '**Calibration target: 1-3 correct out of 10.** The validator',
        'flags 0/10 (too pessimistic — a real 0.0 student gets lucky',
        'sometimes) and ≥4/10 (you\'re using prior knowledge you',
        'shouldn\'t claim) as failures.',
        '',
        'These 10 questions stress HP-specific concepts: NOG/KVA option',
        'taxonomies, KaTeX-heavy XYZ, MEK three-blank coordination,',
        'literary-critical LÄS, academic ELF. A 0.0 student:',
        '',
        '- WILL get lucky on 1-3 of them by ear or arithmetic alone',
        '  (e.g. a simple unit-conversion XYZ, an ORD where the word',
        '  is in everyday vocabulary)',
        '- WILL NOT solve the NOG taxonomy (no concept of "ensam',
        '  räcker"), KVA structural answers (no concept of "A means',
        '  I > II"), or HP-specific MEK three-blank coordination',
        '- SHOULD output `cant_solve` whenever the persona toolkit',
        '  (see 00.md "What you DON\'T know") covers the obstacle',
        '',
        '**Default to `cant_solve`** when in doubt. The cost of an',
        'honest cant_solve is zero; the cost of a guess that "feels',
        'right" is corrupted calibration that propagates through all',
        f'{n_practice} practice rounds.',
        '',
    ]
    for qid in baseline:
