 ...
 *  Palette default is Spalt (L12 ivory + cobalt) — the 2026 Boksidan redesign
 *  colorway; cobalt --accent is reserved for structure, grading uses the
 *  semantic --ok/--bad tokens. See docs/design-system-conventions.md. */
export const DEFAULT_THEME = {
  palette: 'spalt' as PaletteKey,
